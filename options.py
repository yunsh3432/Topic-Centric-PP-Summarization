...
def add_pplm_args(parser):
    group = parser.add_argument_group('PPLM')
    group.add_argument('--data_dir', type=str)
    group.add_argument('--bag_of_words', type=str)
    group.add_argument('--num_samples', type=int, default=1)
    group.add_argument('--length', type=int, default=100)
    group.add_argument('--output_dir', type=str, default='result')

    #PPLM hyper parameter
    group.add_argument('--top_k', type=int, default=50)
    group.add_argument('--temperature_pplm', type=float, default=0.9)
    group.add_argument('--step_size', type=float, default=0.03)
    group.add_argument('--num_iterations', type=int, default=1)
    group.add_argument('--grad_length', type=int, default=10000)
    group.add_argument('--window_length', type=int, default=0)
    group.add_argument('--horizon_length', type=int, default=1)
    group.add_argument('--decay', action='store_true')
    group.add_argument('--gamma', type=float, default=1.5)
    group.add_argument('--gm_scale', type=float, default=0.95)
    group.add_argument('--kl_scale', type=float, default=0.01)
    group.add_argument('--verbosity', type=str, default='quiet')
    group.add_argument('--no_cuda', action='store_true', help='no_cuda')
